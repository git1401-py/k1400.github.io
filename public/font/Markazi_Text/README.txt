...
This means all the styles are contained in a single file:
  Markazi_Text/MarkaziText-VariableFont_wght.ttf

If your app fully supports variable fonts, you can now pick intermediate styles
that aren’t available as static fonts. Not all apps support variable fonts, and
in those cases you can use the static font files for Markazi Text:
  Markazi_Text/static/MarkaziText-Regular.ttf
  Markazi_Text/static/MarkaziText-Medium.ttf
  Markazi_Text/static/MarkaziText-SemiBold.ttf
  Markazi_Text/static/MarkaziText-Bold.ttf
